...
describe('Create a customer, login, make a purchase and finally delete it', () => {
    ...
    it('Create customer', () => __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield agent3.post(`${urlBase3}/api/customer/`)
            .send(datos)
    ...
    it("Login", () => __awaiter(this, void 0, void 0, function* () {
        const response = yield agent3.post(`${urlBase3}/login/`)
            .send({ username: 'sallyv', password: 'sallypassword' })
            .set('User-Agent', 'agent');
        chai2.expect(response.status).to.equal(200);
        token = response.body.token;
    }));
    it("Attempt to login with wrong password", () => __awaiter(this, void 0, void 0, function* () {
        yield agent3.post(`${urlBase3}/login/`)
    ...
    it("Attempt to login with wrong username", () => __awaiter(this, void 0, void 0, function* () {
        yield agent3.post(`${urlBase3}/login/`)
    ...
    it("Purchase", () => __awaiter(this, void 0, void 0, function* () {
        const response = yield agent3.get(`${urlBase3}/purchase/`)
            .set("Authorization", `Bearer ${token}`)
            .set('User-Agent', 'agent');
        chai2.expect(response.status).to.equal(200);
        chai2.expect(response.body).length > 0;
    }));
    it("Delete customer", () => __awaiter(this, void 0, void 0, function* () {
        const response = yield agent3.delete(`${urlBase3}/api/customer/${id}`)
            .set('User-Agent', 'agent');
        chai2.expect(response.status).to.equal(204);
    }));
    it("Attempt to purchase without logging in", () => __awaiter(this, void 0, void 0, function* () {
        yield agent3.delete(`${urlBase3}/api/customer/${id}`)
            .set('User-Agent', 'agent')
            .catch(error => {
...
//# sourceMappingURL=loginAndPurchase.test.js.map